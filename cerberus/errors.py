...
ERROR_ITEMS_LIST = "'%s': length of list should be %d"
...
ERROR_EMPTY_BAD_TYPE = "'empty' rule only applies to string fields"
ERROR_EMPTY_NOT_ALLOWED = "empty values not allowed for field '%s'"
