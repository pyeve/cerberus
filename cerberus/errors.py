...
ERROR_SCHEMA_BAD_DEPENDENCY = \
    "dependency-definition for {0} must be a dict or a list"
ERROR_SCHEMA_CONSTRAINT_TYPE = "the constraint for '{0}' must be a dict"
ERROR_SCHEMA_DEFINITION_CALLABLE = \
    "coerce- and validator-definitions must be a callable"
ERROR_SCHEMA_FORMAT = "'{0}' is not a schema, must be a dict"
ERROR_SCHEMA_INVALID_DEPENDENCY = "{0} is no valid dependency for {1}"
ERROR_SCHEMA_MISSING = "validation schema missing"
ERROR_SCHEMA_TYPE = "'{0}' is not a schema, must be a dict"
ERROR_SCHEMA_TYPE_TYPE = "type of field '{0}' must be either 'list' or 'dict'"
